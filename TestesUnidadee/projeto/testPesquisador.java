...
class testPesquisador {
	...
	public void testaConstrutorPesquisador() {
		try {
			Pesquisador pesquisador = new Pesqusiador("Gabriel", "Cientista", "ele estuda como os macaco podem vir a se tornar superiores aos humanos", "bielzinop12@2001biel", "https://godbiel");
		} catch (Exception e) {
	...
	@Test
	public void testaPesquisadorNulo() {
		try {
	...
	@Test
	public void testaPesquisadorVazio() {
		try {
